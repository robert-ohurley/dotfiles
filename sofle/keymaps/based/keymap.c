 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | XXXX | XXXX | CTRL |LOWER | / BSPC  /       \ SPC  \  |RAISE | CTRL | XXXX | XXXX |
 *            |      |      |      |      |/ SHIFT /         \ SHIFT\ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_SYMBOLS] = LAYOUT( \
    ...
    XXXXXXX,   KC_1,     KC_2,           KC_3,     KC_4,     KC_5,                                  KC_6,     KC_7,    KC_8,           KC_9,          KC_0,           XXXXXXX, \
    XXXXXXX,   KC_PLUS,  KC_MINS,        KC_LCBR,  KC_RCBR,  LSFT(KC_QUOT),                         XXXXXXX,  KC_EQL,  KC_LPRN,        KC_RPRN,       KC_COLN,        XXXXXXX, \
    XXXXXXX,   KC_GRV,   LSFT(KC_MINS),  KC_LBRC,  KC_RBRC,  KC_QUOT,       XXXXXXX,     XXXXXXX,   KC_PIPE,  KC_BSLS, LSFT(KC_COMMA), LSFT(KC_DOT),  LSFT(KC_SLASH), XXXXXXX, 
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | XXXX | Tab  | Pscr | Menu | Alt  | Del  |                    | ____ | PWrd |  Up  | NWrd | DLine| XXXX |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_ACTIONS] = LAYOUT( \
  ...
  XXXXXXX, KC_TAB,  KC_PSCR, KC_APP,  KC_LALT,  KC_DEL,                            KC_PGUP, KC_PRVWD, KC_UP,   KC_NXTWD, KC_DLINE, XXXXXXX, \
